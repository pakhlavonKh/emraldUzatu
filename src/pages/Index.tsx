    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center bg-primary text-primary-foreground overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-serif text-7xl md:text-9xl mb-4 text-accent font-light">
            Гүлнара
          </h1>
      ...
      <section className="relative py-20  md:py-28 bg-secondary text-secondary-foreground overflow-hidden">
        ...
        >
          ...
          <p className="font-serif text-m md:text-lg leading-relaxed">
            ...
            <span className="font-serif text-lg text-accent italic">Гүлнараның</span>{" "}
      ...
      <footer className="relative py-12 bg-green-deep text-primary-foreground/60 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          />
          <p className="font-script text-3xl text-accent mb-2">Гүлнара</p>
